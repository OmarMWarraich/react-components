...
class Game extends Component {
  ...
  */
  ...
  /*
  The render method inside the component gets called automatically everytime the state inside of the 
  component changes and anytime the component's props change (more accurately, anytime React percieves
  that those props have changed, regardless of whether they are actually different e.g., behind 'this'
  inside of the render method causes React to think that the props are different.)
  */
